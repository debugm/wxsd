...
<div class="row">
  ...
  <table class="table table-bordered table-hover table-condensed table-responsive">
    ...
    <tbody id="content">
      <?php if(is_array($acclist)): $i = 0; $__LIST__ = $acclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	...
	<a href="javascript:updateAcc('<?php echo ($vo["id"]); ?>',1)">更新</a>  
            </td>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-describedby="tscontent" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <input type="hidden" id="delid" ajaxurl="<?php echo U("delAcc");?>">
  ...
  <script>
	...
	function addNew(id){
	    ...
	    $.ajax({
              type:'POST',
              url:"<?php echo U('Admin/User/addNew');?>",
    ...
    $("#delid").val(id);
	  ...
	  if(status == 0)
          ...
          $.ajax({
              type:'POST',
              url:"<?php echo U('Admin/User/delacc');?>",
