...
<div class="row">
  ...
  <form class="form-inline" role="form" action="" method="get" autocomplete="off" id="orderform">
    <div class="form-group">
      <input type="text" class="form-control zy-searchstr" id="wxname" name="payid" placeholder="请输入微信交易单号" value="<?php echo ($_GET['payid']); ?>">
    </div>
    <div class="form-group">
	...
	<blockquote class="layui-elem-quote layui-quote-nm" style="font-size:14px;padding;8px;">本页总金额：<span class="label label-info"><?php echo ($stamount); ?>元</span>搜索结果统计金额：<span class="label label-info"><?php echo ($summoney); ?>元</span></blockquote>
  ...
  <table class="table table-bordered table-hover table-condensed table-responsive">
    ...
    <tbody>
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td style="text-align:center; color:#666"><?php echo ($vo["amt"]); ?></td>
