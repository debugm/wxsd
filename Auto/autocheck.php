...
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
$result = curl_exec($ch);
        file_put_contents(dirname(__FILE__)."/autocheck/check.log.txt".date('Ymd'),date('Y-m-d H:i:s').'######SF CHECK######'.PHP_EOL,FILE_APPEND);
        file_put_contents(dirname(__FILE__)."/autocheck/check.log.txt".date('Ymd'),date('Y-m-d H:i:s').$result.PHP_EOL,FILE_APPEND);
        file_put_contents(dirname(__FILE__)."/autocheck/check.log.txt".date('Ymd'),date('Y-m-d H:i:s').'######END SF CHECK######'.PHP_EOL,FILE_APPEND);
